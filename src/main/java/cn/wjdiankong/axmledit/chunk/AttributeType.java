...
public class AttributeType {
    ...
    public static String getAttributeData(AttributeData data) {
        if (data.type == ATTR_STRING) {
            return ChunkParser.xmlStruct.stringChunk.stringContentList.get(data.data);
        }
        ...
        if (data.type == ATTR_BOOLEAN) {
            return data.data != 0 ? String.valueOf(true) : String.valueOf(false);
        }
        ...
        return String.format("type 0x%02X: 0x%X", data.type, data.data);
    }
